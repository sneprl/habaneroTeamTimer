module.exports = function(grunt) {
    ...
    var fileConfig = {
         ...
         */
        app_files: {
            js: [ 'src/**/*.js', '!src/**/*.spec.js', '!src/vendor/**/*.js','!src/karma-unit.js' ],
            jsunit: [ 'src/**/*.spec.js' ],
    ...
    // compilation.
    grunt.registerMultiTask('index', 'Process index.src.html template', function () {
        var dirRE = new RegExp('^(' + grunt.config('dev_dir') + '|' + grunt.config('build_dir') + '|' + grunt.config('compile_dir') + ')\/', 'g');
        ...
        grunt.file.copy('src/index.src.html', this.data.dir + '/index.html', {
